...
object AngConfigManager {
    ...
    fun tryResolveVmess4Kitsunebi(server: String, config: ServerConfig): Boolean {
    ...
    fun tryResolveResolveSip002(str: String, config: ServerConfig): Boolean {
        try {
            val uri = URI(Utils.fixIllegalUrl(str))
            config.remarks = Utils.urlDecode(uri.fragment ?: "")
